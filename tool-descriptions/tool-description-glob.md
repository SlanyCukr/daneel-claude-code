...
- For finding where a symbol is defined, prefer LSP workspaceSymbol over Glob. For understanding a file's structure, use LSP documentSymbol before reading it
